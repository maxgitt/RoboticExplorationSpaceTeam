  ...
  left(4)
{
  ...
  // vel_pub_gaz = nh_.advertise<geometry_msgs::Twist>("/rover/cmd_vel", 1);
  vel_pub = nh_.advertise<geometry_msgs::Twist>("/rover/cmd_vel", 1);
