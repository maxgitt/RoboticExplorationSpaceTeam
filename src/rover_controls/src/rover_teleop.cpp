  ...
  left(4)
{
  ...
  joy_sub = nh_.subscribe<sensor_msgs::Joy>("joy", 10,&Teleoperation::joyCallback, this);

}

bool Teleoperation::is_disabled(){
  if(disabled == true) {
...
void Teleoperation::joyCallback(const sensor_msgs::Joy::ConstPtr& joy)
{
